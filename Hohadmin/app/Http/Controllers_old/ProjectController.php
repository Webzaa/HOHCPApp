...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasfile('rera_certificate'))
        {
            ...
            $location = 'projects/'.$data['project_name'].'/ReraCertificate';
            $reraname->move($location,$rerafilename);
            $rerapath = 'projects/'.$data['project_name'].'/ReraCertificate/'.$rerafilename;
        ...
        if($request->hasfile('hero_image'))
        {
            ...
            $location = 'projects/'.$data['project_name'].'/HeroImage';
            $heroname->move($location,$herofilename);
            $heropath = 'projects/'.$data['project_name'].'/HeroImage/'.$herofilename;
