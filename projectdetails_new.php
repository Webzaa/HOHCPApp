...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="eagleride-download">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#BrouchureModal">Open Brochure
</button>
    ...
    <!-- Modal -->
<div class="modal fade" id="BrouchureModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<iframe src="https://docs.google.com/viewer?url=<?php echo $brouchure; ?>&embedded=true" frameborder="0" height="1000px" width="100%"></iframe>
  </div>
      </div>
